...
nested_path = Path(sys.argv[1] if len(sys.argv) > 1 else "Data/smoke_aspect_labels.jsonl")
flat_path = Path(sys.argv[2] if len(sys.argv) > 2 else "Data/smoke_aspect_labels_flat.jsonl")
