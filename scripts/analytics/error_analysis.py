...
Exemples :
    # Smoke
    python scripts/analytics/error_analysis.py \\
        --data-dir data_splits_smoke \\
        --baseline-dir baseline_outputs_smoke \\
        --bert-dir bert_outputs_smoke \\
        --output-dir error_analysis_smoke
...
sys.path.insert(0, str(REPO_ROOT / "scripts" / "data_train"))
from train_baseline import BiLSTMABSA  # noqa: E402

DEFAULT_DATA_DIR = REPO_ROOT / "data_splits"
DEFAULT_BASELINE_DIR = REPO_ROOT / "baseline_outputs"
DEFAULT_BERT_DIR = REPO_ROOT / "bert_outputs"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "error_analysis"
