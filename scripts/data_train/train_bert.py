...
Prerequis : data_splits/{train,val,test}.jsonl produits par prep_data.py
(champ texte brut "sentence", pas les token_ids LSTM).

Exemples :
    python scripts/data_train/train_bert.py --data-dir data_splits_smoke --output-dir bert_outputs_smoke --max-epochs 1
    python scripts/data_train/train_bert.py --data-dir data_splits --output-dir bert_outputs
"""
...
DEFAULT_DATA_DIR = REPO_ROOT / "data_splits"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "bert_outputs"
...
def main():
    ...
    print(f"Modele et metriques sauvegardes dans {output_dir}/")
