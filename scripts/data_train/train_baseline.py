...
Prérequis : avoir exécuté prep_data.py, qui produit data_splits/{train,val,test}.jsonl
et data_splits/vocab.json.
"""
...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "baseline_outputs"
...
def parse_args():
    ...
    p.add_argument(
        ...
        help="Dossier de sortie (modele, metriques, courbes)",
    )
...
def main():
    ...
    if missing:
        raise FileNotFoundError(
            ...
            "Lancez d'abord prep_data.py (ex. --output-dir data_splits_smoke)."
        )
